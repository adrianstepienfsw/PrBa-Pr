...
def parse_example_proto(example_serialized):
  ...
  feature_map = {
      ...
      'image/class/label0': tf.FixedLenFeature([1], dtype=tf.int64,
                                              default_value=-1),
      'image/class/label1': tf.FixedLenFeature([1], dtype=tf.int64,
                                              default_value=-1),
      'image/class/label2': tf.FixedLenFeature([1], dtype=tf.int64,
                                              default_value=-1),
      'image/class/label3': tf.FixedLenFeature([1], dtype=tf.int64,
                                              default_value=-1),
      'image/class/label4': tf.FixedLenFeature([1], dtype=tf.int64,
                                              default_value=-1),
      'image/class/label5': tf.FixedLenFeature([1], dtype=tf.int64,
                                              default_value=-1),
      'image/class/label6': tf.FixedLenFeature([1], dtype=tf.int64,
                                              default_value=-1),
  ...
  label = []
  label.append(tf.cast(features['image/class/label0'], dtype=tf.int32))
  label.append(tf.cast(features['image/class/label1'], dtype=tf.int32))
  label.append(tf.cast(features['image/class/label2'], dtype=tf.int32))
  label.append(tf.cast(features['image/class/label3'], dtype=tf.int32))
  label.append(tf.cast(features['image/class/label4'], dtype=tf.int32))
  label.append(tf.cast(features['image/class/label5'], dtype=tf.int32))
  label.append(tf.cast(features['image/class/label6'], dtype=tf.int32))
...
def batch_inputs(data_dir, batch_size, image_size, train, num_preprocess_threads=4,
  ...
  with tf.name_scope('batch_processing'):
    ...
    return images, tf.reshape(label_index_batch, [batch_size, 7]), fnames
